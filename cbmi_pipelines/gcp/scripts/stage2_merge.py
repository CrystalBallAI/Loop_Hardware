...
def _import_parsers():
    ...
    from cbmi_pipelines.gcp.scripts.parsers import parse_rinex  # type: ignore
    from cbmi_pipelines.gcp.scripts.parsers import parse_oplog  # type: ignore
    from cbmi_pipelines.gcp.scripts.parsers import parse_user_input  # type: ignore
