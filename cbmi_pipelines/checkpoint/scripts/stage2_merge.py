...
def _import_parsers():
    ...
    from cbmi_pipelines.checkpoint.scripts.parsers import parse_rtk_export  # type: ignore
    from cbmi_pipelines.checkpoint.scripts.parsers import parse_oplog  # type: ignore
    from cbmi_pipelines.checkpoint.scripts.parsers import parse_form  # type: ignore
