...
def main(argv: list[str]) -> int:
    ...
    from cbmi_pipelines.basestation.scripts import stage1_inventory
    ...
    from cbmi_pipelines.basestation.scripts import stage2_merge
    t0 = time.perf_counter()
    ...
    from cbmi_pipelines.basestation.scripts import compute_derived
    t0 = time.perf_counter()
    ...
    from cbmi_pipelines.basestation.scripts import compute_indicators
    t0 = time.perf_counter()
    ...
    from cbmi_pipelines.basestation.scripts import compute_blocks
    t0 = time.perf_counter()
    ...
    from cbmi_pipelines.basestation.scripts import compute_base_score
    t0 = time.perf_counter()
